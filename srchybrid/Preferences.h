...
public:
   ...
   // MORPH END  leuk_he Advanced official preferences. 
	...
	static int	m_uMinModAmount; // Global Mod statistics [Stulle/some code by SlugFiller] - Stulle
	...
	friend class CPPgDesign; // Design Settings [eWombat/Stulle] - Stulle
...
//	static void    SetSivkaAskCounter (uint16 in)	{ m_iSivkaAskCounter = in; }
	...
	static int		GetMinModAmount() {return m_uMinModAmount;} // Global Mod statistics [Stulle/some code by SlugFiller] - Stulle
