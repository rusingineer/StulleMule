...
void CQueueListCtrl::Init()
{
	...
	InsertColumn(14,GetResString(IDS_SMALL),LVCFMT_LEFT,40,15);
	// <== push small files [sivka] - Stulle

	// ==> push rare file - Stulle
	InsertColumn(15,GetResString(IDS_RARE),LVCFMT_LEFT,40,16);
	// <== push rare file - Stulle
...
void CQueueListCtrl::SetAllIcons()
{
	...
	imagelist.Add(CTempIconLoader(_T("RATING_FAKE"))); // Reduce Score for leecher - Stulle
