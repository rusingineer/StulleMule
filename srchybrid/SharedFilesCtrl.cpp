		...
		switch (wParam){
			...
			case MP_PS_AMOUNT_LIMIT_SET:
			{
				...
				if (wParam==MP_PS_AMOUNT_LIMIT_SET)
				{
					...
					if (file)
						currPsAmountLimit.Format(_T("%i"), ((file->GetPsAmountLimit()>=0)?file->GetPsAmountLimit():thePrefs.GetPsAmountLimit()));
					else
